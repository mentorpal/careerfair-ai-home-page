...
import logo3 from "static/favicon.png";
import logo1 from "static/csuf2.png";
import logo4 from "static/DOD.png";
  ...
  return (
    <div className="app-container">
      <Typography className="title" variant="h2" component="h2">
        Welcome to CareerFair.Ai, We will be Live very soon !{" "}
      ...
      <div className="icontainer2">
        <a href=" https://dodstem.us/" target="_blank">
          <img src={logo4} className="logo-img4"></img>
        </a>
